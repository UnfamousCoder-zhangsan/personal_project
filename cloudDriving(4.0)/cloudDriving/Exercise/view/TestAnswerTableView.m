...
@implementation TestAnswerTableView{
    UIView *headView;
    UIView *footerView;
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (_tableViewDataSource[titleNum][@"picture"] !=NULL) {
        ...
        headView = [[UIView alloc] initWithFrame:CGRectMake(5, 0, SCREEN_WIDTH-10, 260)];
        
        headView.backgroundColor = [UIColor whiteColor];
        //headView.backgroundColor = [UIColor colorWithRed:135/255.0 green:206/255.0 blue:250/255.0 alpha:1.0];
        //https://bmob-cdn-26200.b0.upaiyun.com/2019/06/04/25065b53409f1c168086ed52d07b5b1f.jpg
        ...
        UIImageView *image = [[UIImageView alloc]initWithFrame:CGRectMake(10, 70, SCREEN_WIDTH-20, 190)];
        ...
        headView = [[UIView alloc] initWithFrame:CGRectMake(5, 0, SCREEN_WIDTH -10, 150)];
        headView.backgroundColor = [UIColor whiteColor];
        //headView.backgroundColor = [UIColor colorWithRed:135/255.0 green:206/255.0 blue:250/255.0 alpha:1.0];
